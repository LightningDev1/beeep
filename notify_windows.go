...
func toastNotify(title, message, appID, appIcon string) error {
	notification := toastNotification(title, message, appID, pathAbs(appIcon))
	return notification.Push()
}

func toastNotification(title, message, appID, appIcon string) toast.Notification {
	if appID == "" {
		appID = applicationID
	}
